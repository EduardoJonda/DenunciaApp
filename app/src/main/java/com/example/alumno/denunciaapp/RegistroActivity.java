package com.example.alumno.denunciaapp;
...
import com.example.alumno.denunciaapp.modelo.Hash;
        ...
        finaRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (name.getText().toString().isEmpty() || mail.getText().toString().isEmpty() || contra.getText().toString().isEmpty()  || contaAgian.getText().toString().isEmpty()) {
                    Toast.makeText(RegistroActivity.this, "Rellene los datos", Toast.LENGTH_SHORT).show();
                } else {
                    if (pass.equals(pasa)){
                        ...
                        Toast.makeText(RegistroActivity.this, "Las contraseña deben coincidir", Toast.LENGTH_SHORT).show();
                    }
